...
def heatmap(c):
    """
    This function plots heatmap for India by using indicators CO2 emissions from gaseous fuel consumption (% of total), Total greenhouse gas emissions (% change from 1990), Urban population growth (annual %), Arable land (% of land area), Agricultural land (% of land area)
    ...
    """
    indicator = ['CO2 emissions from gaseous fuel consumption (% of total)','Total greenhouse gas emissions (% change from 1990)','Urban population growth (annual %)','Arable land (% of land area)','Agricultural land (% of land area)']
...
#Funtion to plot heatmap for Japan
def heat_map2(f):
    """
    This function plots heatmap for Japan by using indicators CO2 emissions from gaseous fuel consumption (% of total), Total greenhouse gas emissions (% change from 1990), Urban population growth (annual %), Arable land (% of land area), Agricultural land (% of land area)
    ...
    plt.figure(figsize=(20,14))
    sns.heatmap(indicator_df1.corr(),fmt='.2g',annot=True,cmap='BrBG',linecolor='Black')
    plt.title('Japan',fontsize=38)
    plt.xticks(fontsize=30)
    plt.yticks(fontsize=30)
